...
def create_argparser():
    ...
    text_defaults = dict(modality='text',
                         ...
                         config='diffusion_lm/synthetic_data/configs/emnlp2020/experiments'
                                '/difflm_seed0_m3_k128_trainc20000.yaml',
                         model_name_or_path='predictability/diff_models/compress_e=5_b=60_m=gpt2_wikitext-103-raw'
                                            '-v1_None',
