...
if __name__ == '__main__':
    ...
    if args.modality == 'e2e-tgt':
        Model_FILE = f"diff_{args.modality}_{args.padding_mode}_{args.diff_steps}steps_{args.in_channel}dim"
    ...
    COMMANDLINE = f"set OPENAI_LOGDIR={Model_FILE}" \
                  ...
                  f"--save_interval 25000 --lr {args.lr} " \
    ...
    if args.checkpoint:
        COMMANDLINE += f"--resume_checkpoint {Model_FILE}/model{args.checkpoint}.pt"
